      ...
      <div class="container" data-scrollax-parent="true">
        <div class="row slider-text align-items-end">
          <div class="col-md-7 col-sm-12 ftco-animate mb-5">
            ...
            <h1 class="mb-3" data-scrollax=" properties: { translateY: '70%', opacity: .9}">Raising Healthy Smiling Champions</h1>
          </div>
        </div> 
      </div>
    </div>
  ...
  <section class="ftco-section">
    <div class="container">
        ...
        <div class="col-md-7 text-center heading-section ftco-animate">
            <h2 class="mb-2">Raising Healthy Smiling Champions</h2>
            ...
            <div class="col-lg-3 col-md-6 d-flex mb-sm-4 ftco-animate fadeInUp ftco-animated">
              <div class="staff">
                ...
                <div class="info text-center">
                  <h3><a href="{{ route('home.services.show', $item->slug) }}">{{$item->title}}</a></h3>
                  <div class="text">
                    <p>
